...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        a = self.volume - len(self.contents)
        if a < 0:
            s = ''
            return s
        s = additional_contents[a:]
        self.contents = self.contents + additional_contents[:a]
        return s
    ...
    def shrink(self, new_volume):
        ...
        a = self.volume - len(self.contents)
        s = self.contents[a:]
        self.contents = self.contents[:new_volume]
        return s
